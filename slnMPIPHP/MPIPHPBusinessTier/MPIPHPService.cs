...
{
    /// <summary>
    /// Service shell for MPIPHPService
    /// </summary>
    /// <remarks>
    /// <para>$Id$</para>
    /// <author>Author: Sagitec</author>
    /// </remarks>
    public partial class MPIPHPService : ServiceBase
    {
        /// <summary>
        /// The main functional class for this service.
        /// </summary>
        private MPIPHPServer iMPIPHPServer;

        /// <summary>
        /// Performs basic initialization including creating the instance of
        /// <tt>MPIPHPServer</tt> which does the real work for this service.
        /// </summary>
        /// <seealso cref="MPIPHPServer"/>
        public MPIPHPService()
        {
            // This call is required by the Component Designer.
            InitializeComponent();

            // Create the main server instance.
            iMPIPHPServer = new MPIPHPServer();

            this.EventLog.Source = "MPIPHP Service";
        ...
        /// <item>Suspend => calls <tt>iMPIPHPServer.Stop</tt></item>
        /// <item>Resume* => calls <tt>iMPIPHPServer.Start</tt></item>
