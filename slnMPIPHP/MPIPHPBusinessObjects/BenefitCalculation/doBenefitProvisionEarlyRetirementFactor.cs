...
{
	/// <summary>
	/// Class MPIPHP.DataObjects.doBenefitProvisionEarlyRetirementFactor:
	/// Inherited from doBase, the class is used to create a wrapper of database table object.
	/// Each property of an instance of this class represents a column of database table object.  
	/// </summary>
    [Serializable]
    public class doBenefitProvisionEarlyRetirementFactor : doBase
    {
         [NonSerialized]
         public static Hashtable ihstFields = null;
         public doBenefitProvisionEarlyRetirementFactor() : base()
         {
         }
         public int benefit_provision_early_retirement_factor_id { get; set; }
    ...
    [Serializable]
    public enum enmBenefitProvisionEarlyRetirementFactor
    {
         benefit_provision_early_retirement_factor_id ,
