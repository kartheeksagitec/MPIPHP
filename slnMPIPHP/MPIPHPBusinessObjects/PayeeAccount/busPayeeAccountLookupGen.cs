...
{
	/// <summary>
	/// Class MPIPHP.BusinessObjects.busPayeeAccountLookupGen:
	...
	public class busPayeeAccountLookupGen : busMainBase
	{
		...
		/// <summary>
		/// MPIPHP.BusinessObjects.busPayeeAccountLookupGen.LoadPayeeAccounts(DataTable):
		/// Loads Collection object iclbPayeeAccount of type busPayeeAccount.
		/// </summary>
		/// <param name="adtbSearchResult">DataTable that holds search result to fill the collection object busPayeeAccountLookupGen.iclbPayeeAccount</param>
