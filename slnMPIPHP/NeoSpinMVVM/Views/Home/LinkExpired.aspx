...
<body class="logout-bg">
    ...
    <div class="logout-wrapper">
        ...
        <% if (ViewBag.Message == "LinkExpired") { %>
   <h1>The link you are trying to access is expired. Please contact the administrator.</h1>

        <% } else if (ViewBag.Message == "LinkUsed") { %>
        <h1>User is already active. Please login to access.</h1>
        To login Please click on link 
...
<% } %>
        ...
        <%--Commented for Framework Version : 6.0.6.0--%>
