...
public partial class wfmFileDownloadClient : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Framework.SessionForWindow["PDFFile"] != null)
        {
            lbyteFile = (byte[])Framework.SessionForWindow["PDFFile"];
            mimeType = "Application/pdf";
        }

        if (Framework.SessionForWindow[FileDownloadContainer.sessionKey] != null)
        {
            FileDownloadContainer lobjFileDownloadContainer = (FileDownloadContainer)Framework.SessionForWindow[FileDownloadContainer.sessionKey];
            ...
            //else show error?
            Framework.SessionRemove(FileDownloadContainer.sessionKey);
        }
