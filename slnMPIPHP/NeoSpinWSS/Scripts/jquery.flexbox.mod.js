    ...
    $.flexbox = function (div, o) {
        ...
        function displayItems(d, q) {
            ...
            for (var i = 0; i < d[o.resultsProperty].length; i++) {
                ...
                if (o.autoCompleteFirstMatch && !hasHtmlTags && selectedRow === -1) {
                    var firstMatch = data[o.displayValue];
                    if (q.length > 0 && firstMatch.toLowerCase().indexOf(q.toLowerCase()) === 0) {
                ...
                if (exactMatch || (selectedMatch && selectedRow === i)) {
